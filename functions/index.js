...
// replaces keywords with emoji in the "text" key of messages pushed to /messages
exports.emojify =
  ...
  .onWrite(event => {
      ...
      // so we'll first check to exit out of the function early if this isn't
      // a new message
      ...
      // Get the value from the 'text' key of the messages
  ...
  // Returns text with keywords replaced by emojifiedText
  // Replacing with the regular expressions /.../ig does a case-insensitive
